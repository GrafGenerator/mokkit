...
/// <summary>
/// Generates realistic <see cref="Client"/> data with Bogus. A fixed seed keeps generation deterministic so
/// tests are reproducible; callers can pin specific fields via <paramref name="mutate"/>.
/// </summary>
